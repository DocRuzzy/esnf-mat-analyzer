...
class AdvancedBackgroundProcessor:
    """Enhanced background correction with ROI-aware processing."""
...
def update_advanced_background_processor():
    ...
    import esnf_mat_analyzer.processing.advanced_background as abg_module
    
    # Add new methods to the existing class
    original_class = abg_module.AdvancedBackgroundProcessor
    enhanced_class = AdvancedBackgroundProcessor
